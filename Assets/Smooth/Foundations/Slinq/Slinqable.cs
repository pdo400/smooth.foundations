...
namespace Smooth.Slinq {
	...
	public static class Slinqable {
		...
		/// Slinqs created by this method will chain removal operations to the underlying list.
		/// </summary>
		public static Slinq<Stuple<T, int>, IListContext<T>> SlinqWithIndex<T>(this IList<T> list, int startIndex, int step) {
		...
		/// Slinqs created by this method will chain removal operations to the underlying list.
		/// </summary>
		public static Slinq<Stuple<T, int>, IListContext<T>> SlinqWithIndex<T>(this IList<T> list) {
		...
		/// Slinqs created by this method will chain removal operations to the underlying list.
		/// </summary>
		public static Slinq<Stuple<T, int>, IListContext<T>> SlinqWithIndex<T>(this IList<T> list, int startIndex) {
		...
		/// Slinqs created by this method will chain removal operations to the underlying list.
		/// </summary>
		public static Slinq<Stuple<T, int>, IListContext<T>> SlinqWithIndexDescending<T>(this IList<T> list) {
		...
		/// Slinqs created by this method will chain removal operations to the underlying list.
		/// </summary>
		public static Slinq<Stuple<T, int>, IListContext<T>> SlinqWithIndexDescending<T>(this IList<T> list, int startIndex) {
			return IListContext<T>.SlinqWithIndex(list, startIndex, -1);
		}
